  ...
  <div className="ms-font-xl">
    ...
    <ul>
      <li>
        I work for
        {" "}
        <Link href="http://macys.com">Macy's</Link>
        {" "}
  ...
  <div className="ms-font-xl">
    ...
    <ul>
      ...
      <li>
        ...
        and sometimes
        {" "}
        <Link href="http://plnkr.co/users/codegard1">Plunker</Link>
        {" "}
        to test ideas
      </li>
      <li>
        I used to make a lot of electronic music in college, and many of those songs can be found on my
        {" "}
      ...
      <li>
        ...
        {" "}
        <Link href="http://twitter.com/codegard1">Twitter</Link>
        {" "}
        account that I don't use very often
      </li>
    </ul>
  </div>
);
...
export const projects = (
  <div className="ms-font-xl">
    <p>
      Here is a sampling of what I'm doing now:
    </p>
    <ul>
      <li>
        Building
      ...
      <li>
        Working with Gatekeepers and business owners to migrate sites and content from an older site collection (SP 2013) to the new one (SP 2016)
      </li>
      <li>
        Getting used to the
        {" "}
